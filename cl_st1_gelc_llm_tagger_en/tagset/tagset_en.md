...
33. present continuous e.g., it is becoming, they ate causing, we are seeking33. progressive aspect e.g., is becoming, is causing, are seeking
...
55. that-clause controlled by likelihood adjective e.g., it is possible that..., it is probable that...

56. that-clause controlled by attitudinal adjective e.g., I'm afraid that..., They must be aware that..., You're surprised that...

57. that-clause controlled by factive (certainty) noun e.g., the fact that..., the conclusion that..., the observation that...

58. that-clause controlled by likelihood noun e.g., the assumption that..., the belief that..., the hypothesis that...

59. that-clause controlled by attitudinal noun e.g., the hope that..., the fear that..., the view that...

60. to-clause controlled by speech verb e.g., ask <someone> to..., claim to..., show how to...

61. to-clause controlled by verb of desire e.g., agree to..., hope to..., intend to..., prefer to...

62. to-clause controlled by verb of causality/modality e.g., attempt to..., help to..., permit <someone> to..., require <someone> to...

63. to-clause controlled by verb of probability e.g., appear to..., seem to..., tend to...
...
74. fctadvl = factive adverbs, e.g. certainly, definitely, indeed

75. lklydvl = likelihood adverbs, e.g. probably, possibly, perhaps

76. nonfadvl = non-factive adverbs, e.g. allegedly, reportedly

77. gen_emph = emphatic adverbs, e.g. just, really, actually
...
83. sua_vb = suasive verbs, e.g. ask, insist, recommend, suggest

84. pro_do = verb 'do', e.g. do, does, did

85. act_ipv = activity intransitive phrasal verbs, e.g. go on, come back

86. act_tpv = activity transitive phrasal verbs, e.g. carry out, set up

87. aspectpv = aspectual phrasal verbs, e.g. start off, finish up

88. commpv = communication phrasal verbs, e.g. point out, speak up

89. mentalpv = mental phrasal verbs, e.g. figure out, think over
...
95. vcmp = that-clause complement controlled by verb, e.g. believe that..., think that..., know that...

96. mntl_vto = to-clause controlled by cognition verb, e.g. think to..., consider to..., know how to...

97. x1_jto = to-clause controlled by certainty adjective, e.g. certain to..., sure to...

98. x2_jto = to-clause controlled by ability/willingness adjective, e.g. able to..., willing to...

99. x3_jto = to-clause controlled by affect adjective, e.g. happy to..., eager to...
...
915. all_advl = all stance and degree adverbials (amplifr, downtone, atadvl, fctadvl, lklydvl, nonfadvl), e.g. completely, probably, unfortunately903. allwh = all wh-structures (wh_ques, wh_cl), e.g. what, who, how, why
